...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name='父类别', on_delete=models.CASCADE,
                                        related_name='sub_cat', help_text='父类别')
...
class GoodsCategoryBrand(models.Model):
    ...
    desc = models.CharField(default='', max_length=500, verbose_name='品牌描述', help_text='品牌描述')
...
class Goods(models.Model):
    ...
    goods_front_image = models.ImageField(max_length=200, upload_to='goods/images/', null=True, blank=True,
                                          verbose_name='封面图')
...
class GoodsImage(models.Model):
    # 商品轮播图
    goods = models.ForeignKey(Goods, on_delete=models.CASCADE, verbose_name='商品轮播图', related_name='image')
