# Generated by Django 2.0.3 on 2019-03-10 02:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级分类'), (2, '二级分类'), (3, '三级分类')], help_text='类目级别', max_length=10, verbose_name='类目级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='', help_text='品牌描述', max_length=500, verbose_name='品牌描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image', to='goods.Goods', verbose_name='商品轮播图')),
            ],
            options={
                'verbose_name': '商品轮播图',
